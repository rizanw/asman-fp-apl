...
import { fetchFinishedServiceData } from "../../redux/servis/fetchServis";

const ListItemsWithSpinner = WithSpinner(ListItems);

class ServisFinishedContainer extends React.Component {
  constructor() {
    super();
    this.state = {
      data: [],
  ...
  render() {
    const { servisFinishedData: data } = this.props;
          ...
          <Card>
            <CardHeader>
              <div className="d-flex align-items-center">
                <div className="mr-auto">Confirmed</div>
                <div className="px-2">
                  <InputGroup seamless>
...
const mapStateToProps = state => ({
  servisFinishedData: state.servis.finished
});

export default connect(mapStateToProps)(ServisFinishedContainer);
