...
class ServisCompletedContainer extends React.Component {
  constructor() {
    super();
    this.state = {
      data: [],
  ...
  handleSubmit = event => {
    ...
    request({
      ...
      .then(resp => {
        ...
        this.props.dispatch(fetchFinishedServiceData());
  ...
  render() {
    ...
    const { isLoading, dataSearch, checkAll, service_id } = this.state;
