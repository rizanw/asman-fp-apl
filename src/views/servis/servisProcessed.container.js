...
import { fetchProcessedServicesData } from "../../redux/servis/fetchServis";

const ListItemsWithSpinner = WithSpinner(ListItems);

class ServisProcessedContainer extends React.Component {
  constructor() {
    super();
    this.state = {
      data: [],
  ...
  render() {
    const { servisProcessedData: data } = this.props;
...
const mapStateToProps = state => ({
  servisProcessedData: state.servis.processed
});

export default connect(mapStateToProps)(ServisProcessedContainer);
