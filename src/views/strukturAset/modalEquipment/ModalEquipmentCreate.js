...
class ModalEquipmentCreate extends React.Component {
  constructor() {
    super();
    this.state = {
      data: [],
    ...
    return (
      ...
      >
        <FormGroup>
          ...
          <FormSelect
            name="parent_id_induk"
            onChange={e => this.props.fetchSubIndukSelectForm(e.target.value)}
          >
          ...
          <ErrorMessages message={errors.parent_id_induk} />
        </FormGroup>
        ...
        <FormGroup>
          ...
          <FormSelect name="parent_id" onChange={this.handleChange}>
            ...
            {dataSubIndukSelectForm.map((item, key) => (
...
export default connect(mapStateToProps)(ModalEquipmentCreate);
